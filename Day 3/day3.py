...
def main():
    ...
    logging.basicConfig(format=LOGGING_FORMAT,
                        level=logging.INFO,
                        stream=sys.stdout)
    logging.info('Starting the program with {} wires'.format(len(all_wires)))
    #logging.info("The first wire looks like this {}".format(all_wires[0]))
    ...
    for wire in all_wires:
        ...
        for instruction in wire:
            ...
            while(counter<amount):
                #logging.info("We are currently in ({}, {}), the Instruction is {} and the amount is {}".format(
